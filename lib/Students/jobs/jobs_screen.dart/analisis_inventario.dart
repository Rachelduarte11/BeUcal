...
class AnalisisInventario extends StatefulWidget {
  const AnalisisInventario({super.key});

  @override
  State<AnalisisInventario> createState() => _AnalisisInventarioState();
}

class _AnalisisInventarioState extends State<AnalisisInventario> {
 ...
 String textFutureJob = getTextFutureJobFromJobList(0); 
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      if (selectedND == 1) const DetailsButton(selectedIndex: 0,),
                      Visibility(
                              ...
                              children: [
                                ...
                                Center(
                                  child: Container(
                                    ...
                                    child: const MovingAvatar(jobInfoIndex: 0, )),
                                ),
  ...
  Widget noDevelopmentAbilitys(BuildContext context) {
    return Container(
      margin: const EdgeInsets.only(top: 5),
      width: MediaQuery.of(context).size.width * 0.95,
      height: MediaQuery.of(context).size.height * 0.25,
