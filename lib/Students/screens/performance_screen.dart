import 'package:becertus_proyecto/Students/screens/main_performance.dart';
import 'package:becertus_proyecto/Students/screens/nd1_performace.dart';
import 'package:becertus_proyecto/Students/screens/nd2_performance.dart';
import 'package:becertus_proyecto/Students/screens/nd3_performance.dart';
      ...
      body: CustomScrollView(
        slivers: [
          const SliverAppBar(
            ...
            expandedHeight: 64,
            backgroundColor: Colors.transparent, // Altura expandida del app bar
            floating: true,
            pinned: false,
          ...
          SliverToBoxAdapter(
            child: Column(
              ...
              children: [
                ...
                Visibility(
                  visible:
                      selectedND != 1 && selectedND != 2 && selectedND != 3,
                  child: Column(
                    children: [
                      MainPerformance(),
                    ],
